...
class SessionFile
{
  public:
    ...
    inline SessionFile(QUrl url, type fileType, QDateTime modification)
        : fileUrl(url), fileType(fileType), fileModification(modification){};
...
class ChannelDescription
{
  public:
    ...
    inline ChannelDescription(int id, QString color)
        : id(id)
    {
        setColor(color);
    };
...
class TracePosition
{
  public:
    ...
    inline TracePosition(int id, int offset)
        : id(id), offset(offset){};
